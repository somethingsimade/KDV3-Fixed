...
local exploit = getexecutorname and getexecutorname() or identifyexecutor and identifyexecutor() or "CurrentAngle Executor"
...
local customasset = function(id)
	if exploit ~= "CaetSploit" then
		...
		repeat task.wait() until (function() if not isfile then return true end end) or isfile(id)
	else
	...
	if mode == 1 then 
		...
		elseif k == "v" then 
			if dancing == false then 
				...
				timeposcur = sound69.TimePosition 
				sound69:Play()
				playanim(115910850138449) -- uuid. 16361564081
			else
				stopanim()
	...
	if mode == 2 then 
		...
		elseif k == "g" then 
			if dancing == false then 
				...
				timeposcur = sound69.TimePosition 
				sound69:Play()
				playanim(106801620167778) -- uuid. 14887006269
			else
				stopanim()
		...
		elseif k == "j" then 
			if dancing == false then 
				...
				playanim(114660931657915) -- uuid. 93585895457618
			else
				stopanim()
				sound69.PlaybackSpeed = 1
	...
	elseif mode == 3 then 
		...
		elseif k == "c" then 
			if dancing == false then 
				...
				timeposcur = sound69.TimePosition 
				sound69:Play()
				playanim(109167288749488,.35,true,nil,false) -- uuid. 84587788869282
			else
				stopanim()
			end
		elseif k == "v" then 
