...
local ChatLocalRange = 750 -- Local chat range
            ...
            if not Processed then
                if _G.dualWieldGuns == false then
                    if _G.changeSomeStuff == false then
                        if Input.KeyCode == Enum.KeyCode.LeftControl or Input.KeyCode == Enum.KeyCode.ButtonL1 then
                            Tween(
               ...
               -- v.Handle:FindFirstChildWhichIsA("Weld"):Destroy()
                  ...
                  if table.find(originalHats, v.Name) then
                   -- v.Handle:FindFirstChildWhichIsA("SpecialMesh"):Destroy()
                    if v.Name == "Extra Left hand (Blocky)_white" then
                        v.Name = "Left Arm"
                        hats[1] = v.Name
                    elseif v.Name == "Extra Right hand (Blocky)_white" then
                        v.Name = "Right Arm"
                        hats[2] = v.Name
                    elseif v.Name == "Unloaded head" then
                        v.Name = "Left Leg"
                        hats[3] = v.Name
                    elseif v.Name == "brick arm" then
                        v.Name = "Right Leg"
                        hats[4] = v.Name
                    elseif v.Name == "Puffer Vest" then
                        v.Name = "Torso1"
                        hats[5] = v.Name
                        end
        ...
        for i,v in pairs(character1:GetChildren()) do
            ...
            if v:IsA("Accessory") then
             ...
             if v.Name == "Left Arm" or v.Name == "Right Arm" then
                            v.Handle.CFrame = reanimation:FindFirstChild(v.Name).CFrame * CFrame.Angles(math.rad(-120), 0, 0) *CFrame.Angles(0,0,-.005*math.sin(100*tick()))
                        end
                   if v.Name == "Left Leg" then
                            v.Handle.CFrame = reanimation:FindFirstChild(v.Name).CFrame * CFrame.Angles(math.rad(90),math.rad(90),  math.rad(0)) *CFrame.Angles(0,0,-.005*math.sin(100*tick()))
                       end
                        ...
                        if v.Name == "Torso1" then
                           -- character1.HumanoidRootPart.CFrame = reanimation.Head.CFrame * CFrame.new(0,-1.5,0)
                            v.Handle.CFrame = reanimation.Torso.CFrame * CFrame.new(-0, 0, 0) * CFrame.Angles(math.rad(0), 0, 0) *CFrame.Angles(0,0,-.005*math.sin(100*tick()))
                      end
