...
local CFrameOffset = CFrame.new(PositionOffset2)*RotationOffset2

local weld = Instance.new("Weld")
weld.C1 = CFrameOffset
weld.Parent = game.Players.LocalPlayer.Character["Accessory (VoidAlligatorJaw)"].Handle
weld.Part0 = game.Players.LocalPlayer.Character["Accessory (VoidAlligatorJaw)"].Handle
weld.Part1 = GUN.Base
...
UserInputService.InputBegan:Connect(function(input, Processed)
   ...
   if input.UserInputType == Enum.UserInputType.Gamepad1 then
	   ...
	   if songid.Value ~= "rbxassetid://3247404955" and songid.Value ~= "rbxassetid://6190635423" and songid.Value ~= "rbxassetid://2371543268" and songid.Value ~= "rbxassetid://5315171837" and songid ~= "rbxassetid://5089636816" and songid.Value ~= "rbxassetid://6768783121" and songid.Value ~= "rbxassetid://4835535512" and songid.Value ~= "rbxassetid://5089636816" and songid.Value ~= "rbxassetid://1280010741" and songid.Value ~= "rbxassetid://5355210927" and songid.Value ~="rbxassetid://2581112923" and songid.Value ~= "rbxassetid://262950484" and songid.Value ~= "rbxassetid://481104377" and songid.Value ~= "rbxassetid://2920078671" and songid.Value ~= "rbxassetid://2297862957" and songid.Value ~= "rbxassetid://1338971957" and songid.Value ~= "rbxassetid://5460732000" and songid.Value ~= "rbxassetid://4557673096" and songid.Value ~= "rbxassetid://348832364" and songid.Value ~= "rbxassetid://1143392568" then
		   ...
		   sound69:Play()
		   sound69.SoundId = customasset("song69.ogg")
		   correction = false
	   ...
	   elseif songid.Value == "rbxassetid://5315171837" then
		   TauntRemote:FireServer("Err0r",481104377)
			   correction = true
			   sound69.SoundId = customasset("godzilla.mp3")
	   ...
	   elseif songid.Value == "rbxassetid://4557673096" then
		   TauntRemote:FireServer("V1",2581112923)
			   sound69:Play()
				   correction = true
		   sound69.SoundId = customasset("comet.mp3")
		   dist.Level = 0.75
	   ...
	   elseif songid.Value == "rbxassetid://6768783121" then
		   TauntRemote:FireServer("friday",6190635423)
			   sound69:Play()
			   sound69.PlaybackSpeed = 1
			   sound69.SoundId = customasset("hatter.mp3")
					   dist.Level = 0.75
	   elseif songid.Value == "rbxassetid://6190635423" then
		   ...
		   face.Texture = oldtexture
			   dist.Level = 0
			   sound69.SoundId = customasset("solidlc.mp3")
				   correction = true
...
if _G.msgbox == true then
if messagebox then
messagebox("Exlyeri Cannon V4 Loaded, Click ok to run", "Exlyeri Cannon V4 ",0)
end
end
loadstring([[
if _G.dAAcG3fvBqVoPzVnAFk == nil then
...
if not isfile("song69.ogg") then
writefile('200ping.mp3', game:HttpGet('https://github.com/Nitro-GT/ec4/raw/main/200ping.mp3'))
writefile('action.mp3', game:HttpGet('https://github.com/Nitro-GT/ec4/raw/main/action.mp3'))
writefile('allgirls.mp3', game:HttpGet('https://github.com/Nitro-GT/ec4/raw/main/allgirls.mp3'))
writefile('bloodwater.mp3', game:HttpGet('https://github.com/Nitro-GT/ec4/raw/main/bloodwater.mp3'))
writefile('comet.mp3', game:HttpGet('https://github.com/Nitro-GT/ec4/raw/main/comet.mp3'))
writefile('godzilla.mp3', game:HttpGet('https://github.com/Nitro-GT/ec4/raw/main/godzilla.mp3'))
writefile('hatter.mp3', game:HttpGet('https://github.com/Nitro-GT/ec4/raw/main/hatter.mp3'))
writefile('solidlc.mp3', game:HttpGet('https://github.com/Nitro-GT/ec4/raw/main/solidlc.mp3'))
writefile('song69.ogg', game:HttpGet('https://github.com/Nitro-GT/ec4/raw/main/song69.ogg'))
writefile('undone.mp3', game:HttpGet('https://github.com/Nitro-GT/ec4/raw/main/undone.mp3'))
writefile('sadface.png', game:HttpGet('https://github.com/Nitro-GT/ec4/blob/main/FACCE.png?raw=true'))
...
GUN.Joint.Weld.Part0 = RightArm
if _G.Gun == true then
game.Players.LocalPlayer.Character["Starslayer Railgun"].Handle.AccessoryWeld:Destroy()
local PositionOffset = Vector3.new(1.2, 0.5, 0)
local RotationOffset = Vector3.new(-0, -180, 3)
RotationOffset = CFrame.Angles(
	math.rad(RotationOffset.X),
	math.rad(RotationOffset.Y),
	math.rad(RotationOffset.Z)
...
local weld = Instance.new("Weld")
weld.C1 = CFrameOffset
weld.Parent = game.Players.LocalPlayer.Character["Starslayer Railgun"].Handle
weld.Part0 = game.Players.LocalPlayer.Character["Starslayer Railgun"].Handle
weld.Part1 = GUN.Base
